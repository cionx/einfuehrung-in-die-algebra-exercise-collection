...
\begin{question}[subtitle = Die Einheitengruppe]
...
\begin{solution}
  \begin{enumerate}
    \item
      Für je zwei Einheiten $xy \in R^\times$ ist auch $xy$ eine Einheit, also $xy \in R^\times$, da $(xy)(y^{-1}x^{-1}) = x y y^{-1} x^{-1} = x x^{-1} = 1$ gilt.
