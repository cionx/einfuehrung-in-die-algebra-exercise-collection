...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      Auch $R_S$ ist wieder ein Hauptidealring:
      ...
      Dies folgt aber daraus, dass $R$ ein Integritätsbereich ist, und $R_S$ daher als Unterring des Quotientenkörpers $Q(R)$ realisiert werden kann.
  \end{enumerate}
\end{solution}
