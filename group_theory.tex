...
\begin{question}[subtitle ={Wirkung von $p$-Grupppen}]
  Eine endliche $p$-Gruppe $G$ wirke auf einer endlichen Menge $X$.
  \begin{enumerate}
    \item
      ...
      \]
    \item
      Gilt $p \nmid |G|$, so besitzt die Wirkung einen Fixpunkt.
    \item
...
\begin{solution}
  \begin{enumerate}
    \item
      ...
      \]
    \item
      Nach dem vorherigen Aufgabenteil gilt $|X^G| \equiv |X| \not\equiv 0 \pmod{p}$, und somit insbesondere $|X^G| \neq 0$.
    \item
