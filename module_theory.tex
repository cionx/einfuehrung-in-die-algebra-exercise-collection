...
\begin{question}
  \begin{enumerate}
    \item
      ...
      Zeigen Sie, dass $M$ genau dann noethersch ist, wenn $M$ noethersch ist.
    \item
...
\begin{question}
  \begin{enumerate}
    \item
      Geben Sie für einen passenden kommutativen Ring $R$ eine kurze exakte Sequenz $0 \to N \to M \to P \to 0$ von $R$-Moduln an, die nicht spaltet.
    \item
