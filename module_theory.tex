...
\begin{solution}
  \begin{enumerate}
    \item
      ...
      Eine $\Integer/n$-Modulstruktur auf einer abelschen Gruppe $A$ entspricht einer $\Integer$-Mo\-dul\-struk\-tur auf $A$, so dass $n \cdot A = 0$ (siehe Übung~\ref{question: extension of module structures onto quotients and localizations}).
...
\begin{solution}
  ...
  Die Injektivität von $\varphi$ ergibt sich daraus, dass $R = \generate{1}_R$, und somit jeder $R$-Mo\-dul\-homo\-mor\-phis\-mus $f \colon R \to M$ durch den Funktionswert $f(1)$ bereits eindeutig bestimmt ist.
...
\begin{question}[subtitle = Moduln über Lokalisierungen und Quotienten]
  ...
  \begin{enumerate}
    \item
      Zeigen Sie, dass sich die $R$-Modulstruktur auf $M$ genau dann zu einer $R/I$-Mo\-dul\-struk\-tur fortsetzen lässt, wenn $IM =  0$ gilt (d.h.\ wenn $am = 0$ für alle $a \in I$ und $m \in M$ gilt).
      Entscheiden Sie auch, ob diese Fortsetzung eindeutig ist.
    \item
      Zeigen Sie, dass sich die $R$-Modulstruktur auf $M$ genau dann zu einer $R_S$-Mo\-dul\-struk\-tur fortsetzen lässt, wenn für jedes $s \in S$ die Abbildung $\lambda_s \colon M \to M$, $m \mapsto sm$ bijektiv ist.
      Entscheiden Sie auch, ob diese Fortsetzung eindeutig ist.
  \end{enumerate}
\end{question}
...
\begin{question}[subtitle = Einschränkung kurzer exakter Sequenzen]
  ...
  Dabei bezeichnen $f' \colon f^{-1}(M') \to M'$, $m \mapsto f(m)$ und $g' \colon M' \to g(M')$, $m \mapsto g(m)$ die jeweiligen Einschränkungen von $f$ und $g$.
\end{question}
...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      ...
      Wir zeigen, dass dann bereits $\generate{m_1, \dotsc, m_s, m_{s+1}, \dotsc, m_t}_R = M$ gilt:
...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      ...
      Für die Exaktheit an $\torsion(M)$ bemerken wir zunächst, dass
      \[
          \torsion(g) \circ \torsion(f)
        = \torsion(g \circ f)
        = \torsion(0)
        = 0
      \]
      gilt, und somit $\im \torsion(f) \subseteq \ker \torsion(g)$ gilt.
      ...
      Also gilt $m = f(n) = \torsion(f)(n) \in \im \torsion(f)$ und somit auch $\ker \torsion(g) \subseteq \im \torsion(f)$.
...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      ...
      Dann gilt $M_1 \cong M_2 \cong R$ und somit
      \[
          \annihilator(M_1)
        = \annihilator(M_2)
        = \annihilator(R)
...
\begin{solution}
  ...
  \begin{enumerate}
    \item
      Wir betrachten $M_1 = M_2 = \bigoplus_{n \geq 0} R = R \oplus R \oplus R \oplus \dotsb$ und die Untermoduln
      \begin{align*}
        N_1 &= 0 \oplus \bigoplus_{n \geq 1} R = 0 \oplus R \oplus R \oplus \dotsb \,.  \\
        N_2 &= 0 \oplus 0 \oplus \bigoplus_{n \geq 2} R = 0 \oplus 0 \oplus R \oplus \dotsb
      \end{align*}
    ...
    \item
      Wir betrachten erneut $M_1 = M_2 = \bigoplus_{n \geq 0} R$, dieses Mal mit den jeweiligen Untermoduln
      \begin{align*}
        N_1 &= R \oplus \bigoplus_{n \geq 1} 0 = R \oplus 0 \oplus 0 \oplus \dotsb \,,  \\
        N_2 &= R \oplus R \oplus \bigoplus_{n \geq 2} 0 = R \oplus R \oplus 0 \oplus 0 \oplus \dotsb
      \end{align*}
