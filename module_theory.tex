...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      Für alle $j \in J$ ergibt sich aus der Inklusion $M_j \subseteq \sum_{i \in I} M_i$ die Inklusion $\annihilator( \sum_{i \in I} M_i ) \subseteq \annihilator(M_j)$, und somit insgesamt die Inklusion $\annihilator( \sum_{i \in I} M_i ) \subseteq \bigcap_{i \in I} \annihilator(M_i)$.
      ...
      Da jedes $m \in \sum_{i \in I} M_i$ eine endliche Summe solcher $m_i$ ist, gilt bereits $xm = 0$ für alle $m \in \sum_{i \in I} M_i$, also $x \in \annihilator( \sum_{i \in I} M_i )$.
