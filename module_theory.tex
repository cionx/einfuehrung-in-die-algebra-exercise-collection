...
\begin{question}
  Es sei $M$ ein $R$-Modul und $(M_i)_{i \in I}$ eine Familie von Untermoduln $M_i \subseteq M$.
  \begin{enumerate}
    \item
      Zeigen Sie, dass $\annihilator( \sum_{i \in I} M_i) = \bigcap_{i \in I} \annihilator(M_i)$.
    \item
      Zeigen Sie, dass $\annihilator( \bigcap_{i \in I} M_i) \supseteq \sum_{i \in I} \annihilator(M_i)$.
    \item
...
\begin{solution}
  Für jedes Ideal $K \subseteq R$ gilt $\annihilator(R/K) = K$ (siehe Übung~\ref{question: annihilators of quotients}), weshalb $I = \annihilator(R/I) = \annihilator(R/J) = J$ gilt.
\end{solution}
