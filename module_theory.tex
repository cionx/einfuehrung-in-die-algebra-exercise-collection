...
\begin{solution}
  \begin{enumerate}
    ...
    \item
      Die Aussage ist wahr:
      Ist $f \colon \Integer/2 \to \Integer/3$ ein Homomorphismus, so ist $2 \cdot f(\overline{1}) = f(\overline{2}) = f(\overline{0}) = \overline{0}$.
...
\begin{question}[Abelsche Gruppen endlicher Ordnung]
...
\begin{question}[subtitle = Smith-Normalform]
